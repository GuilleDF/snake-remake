...
public class Snake {
	 ...
	 * <br>
	 * TODO: Right now a block can only be added if all the other blocks have
	 * been moved at least once<br>
	 * (that way they all have a {@link SnakeBlock#lastPosition lastPosition})
	 */
	 ...
	 * <br><br>
	 * Call {@link #calculateColors()} before using this method
	 * @param bitmap
	 */
